...
*/
    makePublic(passphrase) {
      if(this._type === 'private' && this._current.der){
        ...
        this._setJwk(jwkey);
        //todo: need to update _der key from private to public
        return this
...
const asn1enc_toJwk = (key, format, {outputPublic, passphrase}) => {
    ...
    // todo : try to outputPublic further on code
...
const asn1rsa_toJwk = (decoded, type, outputPublic) => {
...
const asn1ec_toJWK = (decoded, type, outputPublic) => {
    if (type === 'public'){ // SPKI
