...
*/
    makePublic(passphrase) {
      if(this._type === 'private' && this._isEncrypted && this._current.der){
        if (typeof passphrase === 'undefined') passphrase = ''
        jwkey = asn1enc_toJwk(this._der, 'der', {outputPublic: true, passphrase});
        this._setJwk(jwkey);
        return this
...
const asn1enc_toJwk = (key, format, {outputPublic, passphrase}) => {
    ...
    console.debug(decoded.privateKeyAlgorithm)
